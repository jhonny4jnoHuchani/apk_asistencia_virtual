...
class _RegistroFacialScreenState extends State<RegistroFacialScreen> {
  ...
  final List<Map<String, String>> _posiciones = [
    ...
    {
      'nombre': 'izquierda',
      'descripcion': 'Gira a la izquierda',
      'icono': '👈'
    },
  ...
  Future<void> _iniciarCamara() async {
    try {
      ...
      _cameraController = CameraController(frontal, ResolutionPreset.medium,
          enableAudio: false);
  ...
  Future<void> _iniciarCapturaAutomatica() async {
    ...
    await _flutterTts
        .speak('Iniciando captura automática. Sigue las instrucciones.');
  ...
  Future<void> _capturarYEnviar() async {
    ...
    try {
      ...
      final nuevaPosicion = _calcularPosicion(
  ...
  Widget build(BuildContext context) {
    if (_errorCamara != null) {
      return Scaffold(
        ...
        body: Center(
            child:
                Text(_errorCamara!, style: const TextStyle(color: Colors.red))),
      );
    }
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text('$_capturasRealizadas de $_totalCapturas',
                        style: const TextStyle(
                ...
                child: Row(children: [
                  ...
                  Expanded(
                      child: Column(
                          ...
                          children: [
                        Text('🔊 ${pos['nombre']!.toUpperCase()}',
                            style: const TextStyle(
                                color: Colors.green,
                                fontSize: 16,
                                fontWeight: FontWeight.bold)),
                        Text(pos['descripcion']!,
                            style: const TextStyle(
